...
public class EnumParameters {
    ...
    public static final EnumProxy<RecipeBookCategories> FLAVORED_KEG_FOOD = new EnumProxy<>(
            RecipeBookCategories.class, (Supplier<List<ItemStack>>) () -> List.of(new ItemStack(FlavoredItems.SWEET_BERRY_WINE.get()))
    );
    public static final EnumProxy<RecipeBookCategories> FLAVORED_KEG_MISC = new EnumProxy<>(
            RecipeBookCategories.class, (Supplier<List<ItemStack>>) () -> List.of(new ItemStack(Items.LAVA_BUCKET), new ItemStack(Items.FERMENTED_SPIDER_EYE))
    );
