...
public class ChocolateCraveOverlay
{
    public static int foodIconsOffset;
    private static final ResourceLocation CHOCOLATE_CRAVE_TEXTURES = ResourceLocation.fromNamespaceAndPath(Flavored.MOD_ID, "textures/gui/chocolate_crave.png");
    private static final ResourceLocation HANGOVER_TEXTURES = ResourceLocation.fromNamespaceAndPath(Flavored.MOD_ID, "textures/gui/hangover.png");
    ...
    public static void drawSugarCraveOverlay(FoodData foodData, Minecraft minecraft, GuiGraphics graphics, int right, int top, boolean naturalHealing) {
        ...
        for (int j = 0; j < 10; ++j) {
            ...
            // Background texture
            graphics.blit(CHOCOLATE_CRAVE_TEXTURES, x, y, 0, 0, 9, 9);
            ...
            if (effectiveHungerOfBar >= 1)
                graphics.blit(CHOCOLATE_CRAVE_TEXTURES, x, y, 18 + naturalHealingOffset, 0, 9, 9);
            else if (effectiveHungerOfBar >= .5)
                graphics.blit(CHOCOLATE_CRAVE_TEXTURES, x, y, 9 + naturalHealingOffset, 0, 9, 9);
        }
