...
public class MixingBowlResultSlot extends SlotItemHandler
{
    public final MixingBowlBlockEntity blockEntity;
    private final Player player;
    private int removeCount;

    public MixingBowlResultSlot(Player player, MixingBowlBlockEntity blockEntity, IItemHandler inventoryIn, int index, int xPosition, int yPosition) {
