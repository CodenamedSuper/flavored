package com.sidden.flavored.itemhandler;
...
public class KegItemHandler implements IItemHandler
{
    ...
    private static final int SLOT_FERMENTER_INPUT = 1;
    ...
    public ItemStack insertItem(int slot, @Nonnull ItemStack stack, boolean simulate) {
        if (side == null || side.equals(Direction.UP)) {
            ...
            return slot == SLOT_FERMENTER_INPUT ? itemHandler.insertItem(slot, stack, simulate) : stack;
        }
    }
